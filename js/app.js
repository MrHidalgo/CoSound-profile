$(function(){
	...
	let body = document.querySelector('body'),
		styles = getComputedStyle(body);
	
	if(lightOrDark(styles['background-color']) === 'dark') {
		$('.profile__info *').css({color: '#fff'});
	}	else {
		$('.profile__info *').css({color: '#000'});
	}
	
	$('.profile__info').css({opacity: 1});
